...
public class MovieProvider {
    ...
    public static ArrayList<Movie> getMovieItems() {
        if (mItems == null) {
            ...
            movie1.setVideoUrl("http://112.5.254.248/hc.yinyuetai.com/uploads/videos/common/7ABE015D22C88FB1FC591AFF8C46C9DF.mp4?sc\\u003db8b969d10c7451e8\\u0026br\\u003d781\\u0026vid\\u003d2906257\\u0026aid\\u003d13236\\u0026area\\u003dHT\\u0026vst\\u003d0");
            mItems.add(movie1);
